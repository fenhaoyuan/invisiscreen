				...
				if ($product_query->num_rows) {
					...
					foreach ($options as $product_option_id => $option_value) {
						...
						if ($option_query->num_rows) {
                            ...
                            // Stephen
                            if ($option_query->row['name'] == 'Width') {
                                $option_width = $option_value;
                                //echo $option_width;
					...
					if ($this->customer->isLogged()) {
						...
						$customer_group_id = 1;//$this->config->get('config_customer_group_id');
					}
					...
					$this->data[$key] = array(
                        ...
                        // Load custom price if it's set, Stephen
                        'price'           => ($flyscreen_price) ? $flyscreen_price : ($price + $option_price),
						//'total'           => ($price + $option_price) * $quantity,
                        // Load custom price if it's set, Stephen
                        'total'           => ($flyscreen_price) ? $flyscreen_price*$quantity : ($price + $option_price)*$quantity,
